    ...
    const fetchStats = async () => {
      try {
        const [u, p, o] = await Promise.all([
           axios.get('https://diplomreact.apt142.ru/users', { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }}),
           axios.get('https://diplomreact.apt142.ru/products'),
           axios.get('https://diplomreact.apt142.ru/orders', { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }})
        ]);
